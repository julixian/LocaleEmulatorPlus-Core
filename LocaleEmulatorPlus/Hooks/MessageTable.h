...
#define CallNtUserMessageCallA() CALLNTUSERMSGA_(LepGetGlobalData()->NtUserMessageCall)
#define CallNtUserMessageCallW() CALLNTUSERMSGW_(LepGetGlobalData()->NtUserMessageCall)
#define CallNtUserMessageCall() CALLNTUSERMSG_(LepGetGlobalData()->NtUserMessageCall)
...
LEP_MESSAGE_FUNCTION_TABLE gapfnMessageCall[] =
{
